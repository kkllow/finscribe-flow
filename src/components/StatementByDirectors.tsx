...
export const StatementByDirectors = () => {
  return (
    <div className="space-y-6">
      {/* Page 1 */}
      <div className="bg-white rounded-lg border border-border shadow-sm p-6" style={{marginLeft: '1in', marginRight: '1in'}}>
        <div className="mb-6">
        ...
        <div className="space-y-6 text-left mx-10" style={{marginLeft: '1in', marginRight: '1in'}}>
      ...
      {/* Page 2 */}
      <div className="bg-white rounded-lg border border-border shadow-sm p-6" style={{marginLeft: '1in', marginRight: '1in'}}>
        <div className="space-y-6 text-left" style={{marginLeft: '1in', marginRight: '1in'}}>
